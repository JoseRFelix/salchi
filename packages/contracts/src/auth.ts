...
export const ServerAuthSessionMethod = Schema.Literals([
  ...
  "bearer-access-token",
  // Backward-compatible name accepted while clients migrate to bearer-access-token.
...
export const AuthBrowserOperateScope = "browser:operate" as const;
...
export const AuthEnvironmentBootstrapTokenType =
  "urn:salchi:params:oauth:token-type:environment-bootstrap" as const;
...
export const AuthBrowserSessionRequest = AuthBootstrapInput;
