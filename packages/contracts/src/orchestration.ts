...
export const UploadChatPdfAttachment = Schema.Struct({
  type: Schema.Literal("pdf"),
  name: TrimmedNonEmptyString.check(Schema.isMaxLength(255)),
  mimeType: Schema.Literal("application/pdf"),
  sizeBytes: NonNegativeInt.check(Schema.isLessThanOrEqualTo(PROVIDER_SEND_TURN_MAX_PDF_BYTES)),
...
export const OrchestrationEventType = Schema.Literals([
  ...
  "thread.title-regeneration-requested",
  "thread.meta-updated",
...
export const ThreadTitleRegenerationRequestedPayload = Schema.Struct({
  threadId: ThreadId,
  previousTitle: TrimmedNonEmptyString,
  requestedAt: IsoDateTime,
});
...
export type ThreadQueuedTurnSteerRequestedPayload =
  typeof ThreadQueuedTurnSteerRequestedPayload.Type;

export const ThreadQueuedTurnSteeredPayload = Schema.Struct({
  threadId: ThreadId,
  messageId: MessageId,
  turnId: TurnId,
  steeredAt: IsoDateTime,
});
...
export const OrchestrationEvent = Schema.Union([
  ...
  Schema.Struct({
    ...EventBaseFields,
    type: Schema.Literal("thread.title-regeneration-requested"),
    payload: ThreadTitleRegenerationRequestedPayload,
  }),
  Schema.Struct({
    ...EventBaseFields,
  ...
  Schema.Struct({
    ...EventBaseFields,
    type: Schema.Literal("thread.queued-turn-steered"),
    payload: ThreadQueuedTurnSteeredPayload,
  }),
  Schema.Struct({
    ...EventBaseFields,
