...
export const CLIENT_SETTINGS_STORAGE_KEY = "salchi:client-settings:v1";
export const SAVED_ENVIRONMENT_REGISTRY_STORAGE_KEY = "salchi:saved-environment-registry:v1";
