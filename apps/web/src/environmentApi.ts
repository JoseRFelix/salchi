...
export function createEnvironmentApi(rpcClient: WsRpcClient): EnvironmentApi {
  return {
    ...
    preview: {
      ...
      goBack: (input) => rpcClient.preview.goBack(input as never),
      goForward: (input) => rpcClient.preview.goForward(input as never),
      keyboardInput: (input) => rpcClient.preview.keyboardInput(input as never),
      ...
      automation: {
        ...
        respond: (input) => rpcClient.preview.automation.respond(input as never),
        reportOwner: (input) => rpcClient.preview.automation.reportOwner(input as never),
