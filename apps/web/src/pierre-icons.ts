...
const PIERRE_ICON_SPRITE_ID = "salchi-pierre-file-icon-sprite";

const SALCHI_FILE_ICON_SPRITE = `
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" aria-hidden="true">
  <symbol id="salchi-file-icon-package-json" viewBox="0 0 32 32">
    <path d="M2 2H30V30H2" fill="#c12127" />
    <path d="M7.25 7.25h17.5v17.5h-3.5v-14H16v14H7.25" fill="#fff" />
  </symbol>
  <symbol id="salchi-file-icon-tsconfig" viewBox="0 0 32 32">
  ...
  <symbol id="salchi-file-icon-agents" viewBox="0 0 32 32">
  ...
  <symbol id="salchi-file-icon-claude" viewBox="0 0 32 32">
  ...
  <symbol id="salchi-file-icon-readme" viewBox="0 0 32 32">
  ...
  <symbol id="salchi-file-icon-pnpm" viewBox="0 0 32 32">
...
export const SALCHI_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: SALCHI_FILE_ICON_SPRITE,
  byFileName: {
    "package.json": "salchi-file-icon-package-json",
    "tsconfig.json": "salchi-file-icon-tsconfig",
    "agents.md": "salchi-file-icon-agents",
    "claude.md": "salchi-file-icon-claude",
    "readme.md": "salchi-file-icon-readme",
    "pnpm-lock.yaml": "salchi-file-icon-pnpm",
    "pnpm-workspace.yaml": "salchi-file-icon-pnpm",
  },
} satisfies FileTreeIcons;

const completeIconResolver = createFileTreeIconResolver(SALCHI_PIERRE_ICONS);
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${SALCHI_FILE_ICON_SPRITE}`;
