...
it("formats browser startup output with a pairing URL that is independent of log level", () => {
  expect(formatBrowserStartupOutput("http://localhost:3773/pair#token=PAIRCODE")).toContain(
