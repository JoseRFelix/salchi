...
const mapThreadRelationshipFields = (row: typeof ProjectionThreadDbRowSchema.Type) => ({
  parentThreadId: row.parentThreadId ?? null,
  createdByThreadId: row.createdByThreadId ?? null,
  subagentKind: row.subagentKind ?? null,
...
const mapThreadLifecycleFields = (row: typeof ProjectionThreadDbRowSchema.Type) => ({
          ...
          ([
            ...
            Effect.gen(function* () {
              ...
              const threads: ReadonlyArray<OrchestrationThread> = threadRows.map((row) => ({
                ...
                runtimeMode: row.runtimeMode,
                interactionMode: row.interactionMode,
                ...mapThreadRelationshipFields(row),
                branch: row.branch,
  ...
  const getThreadShellById: ProjectionSnapshotQueryShape["getThreadShellById"] = (threadId) =>
    Effect.gen(function* () {
      ...
      return Option.some({
        ...
        ...mapThreadRelationshipFields(threadRow.value),
        ...
        ...mapThreadLifecycleFields(threadRow.value),
