import { ProjectId, type OrchestrationProject } from "@salchi/contracts";
...
const makeProjectionSnapshotQueryLayer = (project: OrchestrationProject) =>
  Layer.succeed(ProjectionSnapshotQuery, {
    ...
    getMostRecentActiveThreadIdByProjectId: () => Effect.die("unused"),
          ...
          ProjectSetupScriptRunnerLive.pipe(
            ...
            Layer.provideMerge(
              Layer.succeed(TerminalManager, {
                ...
                resize: () => Effect.void,
                clear: () => Effect.void,
                snapshot: () => Effect.die(new Error("unused")),
  ...
  it("opens the deterministic setup terminal with worktree env and writes the command", async () => {
    ...
    expect(open).toHaveBeenCalledWith({
      ...
      env: {
        ...
        SALCHI_WORKTREE_PATH: "/repo/worktrees/a",
      },
    });
