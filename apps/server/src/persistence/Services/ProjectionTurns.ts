...
export const ProjectionTurn = Schema.Struct({
  ...
  checkpointAttribution: Schema.NullOr(OrchestrationCheckpointAttribution),
...
export interface ProjectionTurnRepositoryShape {
  ...
  /**
   * Appends a pending-start placeholder row for FIFO turn start correlation.
   */
...
>()("salchi/persistence/Services/ProjectionTurns/ProjectionTurnRepository") {}
