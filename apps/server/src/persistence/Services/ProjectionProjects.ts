 ...
 */
import { IsoDateTime, ModelSelection, ProjectId, ProjectScript } from "@salchi/contracts";
...
>()("salchi/persistence/Services/ProjectionProjects/ProjectionProjectRepository") {}
