import { OrchestrationCheckpointFile } from "@salchi/contracts";
    ...
    execute: (row) =>
      sql`
        ...
        DO UPDATE SET
          ...
          checkpoint_attribution = excluded.checkpoint_attribution,
    ...
    execute: ({ threadId }) =>
      sql`
        SELECT
          ...
          checkpoint_attribution AS "checkpointAttribution",
