import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@salchi/contracts";
...
import { KeybindingsConfigError } from "@salchi/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "salchi-keybindings-test-",
        }),
      ),
    ),
  );
