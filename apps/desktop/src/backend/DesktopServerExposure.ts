...
} from "@salchi/shared/advertisedEndpoint";
import type {
  AdvertisedEndpoint,
...
>()("@salchi/desktop/backend/DesktopServerExposure") {}
...
>()("@salchi/desktop/backend/DesktopServerExposure/DesktopNetworkInterfacesService") {}
