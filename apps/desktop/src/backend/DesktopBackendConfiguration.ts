...
>()("@salchi/desktop/backend/DesktopBackendConfiguration") {}
...
const DESKTOP_BACKEND_ENV_NAMES = [
  ...
  "SALCHI_NO_BROWSER",
  "SALCHI_HOST",
  "SALCHI_DESKTOP_WS_URL",
  "SALCHI_DESKTOP_LAN_ACCESS",
  "SALCHI_DESKTOP_LAN_HOST",
  "SALCHI_DESKTOP_HTTPS_ENDPOINTS",
  "SALCHI_TAILSCALE_SERVE",
  "SALCHI_TAILSCALE_SERVE_PORT",
] as const;
  ...
  > {
    ...
    return {
      ...
      bootstrap: {
        ...
        salchiHome: environment.baseDir,
