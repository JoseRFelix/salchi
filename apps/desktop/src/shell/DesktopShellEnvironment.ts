...
>()("@salchi/desktop/shell/DesktopShellEnvironment") {}
...
const startMarker = (name: string) => `__SALCHI_ENV_${name}_START__`;
const endMarker = (name: string) => `__SALCHI_ENV_${name}_END__`;
