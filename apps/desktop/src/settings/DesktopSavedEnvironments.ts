import { EnvironmentId, type PersistedSavedEnvironmentRecord } from "@salchi/contracts";
import { fromLenientJson } from "@salchi/shared/schemaJson";
...
>()("@salchi/desktop/settings/DesktopSavedEnvironments") {}
